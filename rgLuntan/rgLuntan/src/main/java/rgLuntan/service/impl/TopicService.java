...
public class TopicService implements ITopicService {
    ...
    // 查询指定forumId下的话题
    @Override
    public MyPage<Map<String, Object>> selectByForumId(Integer forumId, Integer pageNo, Integer pageSize) {
        ...
        MyPage<Map<String, Object>> page = topicMapper.selectByForumId(iPage, forumId);
