...
public class RedisCachePlugin {
    ...
    @Around("rgLuntan.hook.TopicServiceHook.selectById()")
    ...
    @Around("rgLuntan.hook.TopicServiceHook.updateViewCount()")
    ...
    @Around("rgLuntan.hook.TopicServiceHook.vote()")
    ...
    @After("rgLuntan.hook.TopicServiceHook.update()")
    ...
    @Around("rgLuntan.hook.CommentServiceHook.selectByTopicId()")
    ...
    @After("rgLuntan.hook.CommentServiceHook.insert()")
    ...
    @After("rgLuntan.hook.CommentServiceHook.update()")
    public void commentUpdate(JoinPoint joinPoint) {
        Comment comment = (Comment) joinPoint.getArgs()[0];
        redisService.delString(String.format(RedisKeys.REDIS_COMMENTS_KEY, comment.getTopicId()));
    }

    @After("rgLuntan.hook.CommentServiceHook.delete()")
    public void commentDelete(JoinPoint joinPoint) {
        Comment comment = (Comment) joinPoint.getArgs()[0];
        redisService.delString(String.format(RedisKeys.REDIS_COMMENTS_KEY, comment.getTopicId()));
    }

    @Around("rgLuntan.hook.CommentServiceHook.vote()")
    ...
    @Around("rgLuntan.hook.UserServiceHook.selectByUsername()")
    ...
    @Around("rgLuntan.hook.UserServiceHook.selectByToken()")
    ...
    @Around("rgLuntan.hook.UserServiceHook.selectById()")
    ...
    @After("rgLuntan.hook.UserServiceHook.delRedisUser()")
