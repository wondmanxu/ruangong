            ...
            <div class="box-header with-border">
                ...
                <#if sec.hasPermission('tag:async')>
                    <div class="d-flex justify-content-end mb-2">
                        <form action="/admin/tag/list" class="form-inline d-flex">
            ...
            <div class="box-body">
                <form action="/admin/tag/list" class="form-inline">
                    <div class="form-group" style="margin-bottom: 10px;">
                        ...
                        <input type="text" name="newTags" value="${newTags!}" class="form-control" placeholder="新标签名">
                        <button type="submit" class="btn btn-primary btn-warning ml-2">添加标签</button>
                    </div>
                </form>
