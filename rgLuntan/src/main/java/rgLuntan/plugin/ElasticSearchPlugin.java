...
public class ElasticSearchPlugin {
    ...
    @Around("rgLuntan.hook.TopicServiceHook.search()")
    ...
    @After("rgLuntan.hook.IndexedServiceHook.indexAllTopic()")
    ...
    @After("rgLuntan.hook.IndexedServiceHook.indexTopic()")
    ...
    @After("rgLuntan.hook.IndexedServiceHook.deleteTopicIndex()")
    ...
    @After("rgLuntan.hook.IndexedServiceHook.batchDeleteIndex()")
